...
const BookAppointment = () => {
  ...
  >([
    ...
    },
    {
      id: 2,
      day: 'Wed',
      timings: ['09:00:00', '13:30:00', '15:30:00', '16:00:00', '17:00:00'],
    },
    {
      id: 3,
      day: 'Fri',
      timings: ['12:00:00', '13:30:00', '18:00:00', '19:30:00', '22:00:00'],
    },
  ]);
  ...
  return (
    <div className="p-6">
        ...
        >
          ...
          <div className="flex flex-col justify-start">
            <div className="flex gap-6 ">
              <div>Availability: {doctor.availability.map((i) => i + ' ')}</div>
      ...
      <div>
        <h2 className="text-black font-semibold text-3xl mb-8">Select Day</h2>
      ...
      <div>
        <h2 className="text-black font-semibold text-3xl mb-8">Select Time</h2>
        {selectedDay && (
